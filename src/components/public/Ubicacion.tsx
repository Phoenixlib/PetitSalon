  ...
  return (
    <section className="py-20 px-4 bg-white relative">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Contenedor del Mapa */}
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border" style={{ borderColor: "var(--ps-lila-pale)" }}>
          <div className="flex flex-col md:flex-row">
            {/* Info Panel */}
            <div className="p-8 md:p-12 md:w-1/3 flex flex-col justify-center border-b md:border-b-0 md:border-r" style={{ borderColor: "var(--ps-lila-pale)", backgroundColor: "var(--ps-lila-pale)" }}>
              ...
              <h3 className="text-2xl font-bold mb-2" style={{ color: "var(--ps-text)" }}>Petit Salon</h3>
              <p className="text-lg mb-6 leading-relaxed" style={{ color: "var(--ps-text-mid)" }}>
                Carvajal 330,<br />
                La Cisterna,<br />
                Santiago, Chile.
              </p>
              <a 
                ...
                style={{ color: "var(--ps-lila-deep)", border: "1px solid var(--ps-lila-mid)" }}
              >
