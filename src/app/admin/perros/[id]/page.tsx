        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white rounded-xl shadow-sm border border-neutral-200 overflow-hidden">
            ...
            <div className="p-6 relative">
              <button className="absolute top-4 right-4 bg-white shadow-sm border border-neutral-200 px-3 py-1.5 rounded-lg text-sm font-medium hover:bg-neutral-50 transition-colors">
                Editar
              </button>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6 border-l-4 border-l-blue-500">
            <div className="flex justify-between items-center mb-4">
              ...
              <button className="text-blue-600 text-sm font-medium hover:underline">Agendar cita</button>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-neutral-200 overflow-hidden">
            <div className="p-6 border-b border-neutral-200 flex justify-between items-center bg-neutral-50/50">
              ...
              <button className="bg-[var(--primary)] text-white px-3 py-1.5 rounded-lg text-sm font-medium hover:opacity-90 transition-opacity">
                + Registrar Atención
              </button>
            </div>
                ...
                dog.attendances.map(record => (
                  <div key={record.id} className="p-6 hover:bg-neutral-50 transition-colors">
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <button className="text-sm text-neutral-400 hover:text-[var(--primary)]">Editar</button>
                    </div>
