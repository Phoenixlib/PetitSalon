...
export default function ClientDetailClient({
  ...
  owner: { id: string; name: string; phone: string; email: string | null; createdAt: Date };
  dogs: Dog[];
}) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6 md:col-span-1 h-fit">
          <div className="flex justify-between items-start mb-4">
            ...
            <button onClick={() => setIsOwnerOpen(true)} className="text-sm text-[var(--primary)] hover:underline">
              Editar
            </button>
          </div>
        ...
        <div className="md:col-span-2 space-y-6">
          <div className="flex justify-between items-center">
            ...
            <button onClick={() => setIsAddDogOpen(true)} className="bg-orange-100 text-orange-800 px-3 py-1.5 rounded-lg text-sm font-medium hover:bg-orange-200 transition-colors">
              + Agregar Mascota
            </button>
          </div>
