...
const ServiceSchema = z.object({
  ...
  price: z.coerce.number().int("El precio debe ser un entero (CLP)").min(0, "El precio no puede ser negativo"),
...
export async function createServiceAction(
  ...
  try {
    ...
    return { errors: { _form: ["Error al crear el servicio. Intenta de nuevo."] } };
  }
}
